...
export const MOCK_PRODUCTS: Product[] = [
    ...
    { id: 'prod_7', name: 'Siri Belajar Jawi & Hijaiyah (Worksheet Bundle)', category: 'Study Template', price: 29.00, description: 'HLA original worksheet bundle to help kids master Jawi and Hijaiyah at home.', imageUrl: 'https://placehold.co/400x300/2E7D32/FFFFFF?text=Jawi+%26+Hijaiyah' },
    { id: 'prod_8', name: 'Adab Harian Muslim - Digital Busy Book', category: 'Study Template', price: 35.00, description: 'Interactive digital busy book teaching everyday Islamic manners (adab) to young children.', imageUrl: 'https://placehold.co/400x300/1B7A5C/FFFFFF?text=Adab+Busy+Book' },
    { id: 'prod_9', name: 'Rukun Islam & Iman Activity Pack', category: 'Study Template', price: 19.00, description: 'Printable activity pack covering the Pillars of Islam and Faith, themed around the HLA 5 pillars.', imageUrl: 'https://placehold.co/400x300/38B000/FFFFFF?text=Rukun+Islam' },
    { id: 'prod_10', name: 'Panduan Aktiviti Fizikal Anak di Rumah (E-Book)', category: 'E-Book', price: 25.00, description: 'A parent\'s guide to fun, simple physical activities for kids at home, aligned with the HLA fitness pillar.', imageUrl: 'https://placehold.co/400x300/FF9F1C/FFFFFF?text=Aktiviti+Fizikal' },
    { id: 'prod_11', name: 'Rutin Ibadah & Sihat untuk Keluarga Muslim (E-Book)', category: 'E-Book', price: 22.00, description: 'A practical guide for building a daily family routine that balances ibadah and healthy habits.', imageUrl: 'https://placehold.co/400x300/06A77D/FFFFFF?text=Rutin+Ibadah' },
    { id: 'prod_12', name: 'Planner Ibadah, Solat & Senaman (Printable)', category: 'Digital Tool', price: 15.00, description: 'Printable weekly planner combining prayer times, worship tracking, and exercise goals.', imageUrl: 'https://placehold.co/400x300/7F5AF0/FFFFFF?text=Planner+Ibadah' },
    { id: 'prod_13', name: "Kids' Resistance Band Fitness Kit", category: 'Physical Product', price: 45.00, description: 'A lightweight resistance band set with illustrated exercise cards, perfect for family workout sessions.', imageUrl: 'https://placehold.co/400x300/EF6C00/FFFFFF?text=Fitness+Kit' },
    { id: 'prod_14', name: 'Beginner Archery Set - Sukan Sunnah for Kids', category: 'Physical Product', price: 189.00, description: 'Starter archery set (bow, target face, arm guard) introducing kids to the sunnah sport of archery.', imageUrl: 'https://placehold.co/400x300/8D6E63/FFFFFF?text=Archery+Set' },
    { id: 'prod_15', name: 'Buku Aktiviti Kanak-Kanak Islamik', category: 'Physical Product', price: 24.90, description: 'Curated Islamic children\'s activity book from local publishers, great to bundle with our digital worksheets.', imageUrl: 'https://placehold.co/400x300/3D5A80/FFFFFF?text=Buku+Islamik' },
];
