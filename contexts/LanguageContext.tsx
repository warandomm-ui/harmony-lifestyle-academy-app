...
export const translations = {
  ms: {
    ...
    // 5 Pillars HLA
    pillar_truth: 'Kebenaran',
    pillar_consciousness: 'Kesedaran',
    pillar_giving: 'Memberi',
    pillar_patience: 'Kesabaran',
    pillar_forgiveness: 'Kemaafan',
    // Common
    start: 'Mula',
    next: 'Seterusnya',
    back: 'Kembali',
  ...
  en: {
    ...
    // 5 Pillars HLA
    pillar_truth: 'Truth',
    pillar_consciousness: 'Consciousness',
    pillar_giving: 'Giving',
    pillar_patience: 'Patience',
    pillar_forgiveness: 'Forgiveness',
    // Common
    start: 'Start',
    next: 'Next',
    back: 'Back',
