  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        // hide on very small screens via media query handled below
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '560px' }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              animation: 'hla-pulse 2s infinite',
              flexShrink: 0,
            }}/>
          ...
          <h1 style={{
            ...
            marginBottom: '1.5rem',
            animation: 'hla-fadeUp 0.6s ease 0.4s both',
          }}>
            Shape Your{' '}
            <em style={{
              fontStyle: 'italic',
          ...
          <p style={{
            ...
            fontWeight: 300,
            maxWidth: '460px',
            animation: 'hla-fadeUp 0.6s ease 0.6s both',
          }}>
        ...
        <div style={{
          ...
          paddingTop: '1.75rem',
          animation: 'hla-fadeUp 0.6s ease 0.8s both',
        }}>
          {[
      ...
      <div className="auth-right-panel" style={{
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, opacity: 0.5, transform: 'rotate(180deg)' }}>
          <CornerOrnament />
        </div>
        ...
        <div className="auth-form-card" style={{
          width: '100%',
          maxWidth: '420px',
          animation: 'hla-fadeUp 0.7s ease 0.3s both',
        }}>
          {/* Mobile-only wordmark (shown when left hero panel is hidden) */}
          ...
          <div className="auth-header-mb" style={{ marginBottom: '2.5rem' }}>
            <div style={{
              ...
              {isLogin ? 'Member Portal' : 'Join the Academy'}
            </div>
            <h2 style={{
              fontFamily: font.playfair,
              fontSize: '2.2rem',
          ...
          {/* Gold divider */}
          <div className="auth-divider-mb" style={{
            height: 1,
          ...
          <form onSubmit={handleAuth} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              <label style={{
                ...
                textTransform: 'uppercase',
                color: focusedField === 'email' ? C.gold : C.muted,
                marginBottom: '0.5rem',
              ...
              <input
                ...
                style={{
                  ...
                  border: `1px solid ${focusedField === 'email' ? C.gold : 'rgba(201,168,76,0.2)'}`,
                  color: C.cream,
            ...
            <div>
              <label style={{
                ...
                letterSpacing: '0.18em',
                textTransform: 'uppercase',
                color: focusedField === 'password' ? C.gold : C.muted,
                marginBottom: '0.5rem',
                transition: 'color 0.3s',
              }}>
                Password
              ...
              <input
                ...
                style={{
                  width: '100%',
                  background: 'rgba(255,255,255,0.04)',
                  border: `1px solid ${focusedField === 'password' ? C.gold : 'rgba(201,168,76,0.2)'}`,
                  color: C.cream,
                  padding: '0.85rem 1.1rem',
                  fontFamily: font.dmSans,
                  fontSize: '0.9rem',
            ...
            <button
              ...
              disabled={loading}
              style={{
                background: loading ? 'rgba(201,168,76,0.5)' : C.gold,
                color: '#0a0a0f',
                border: 'none',
                padding: '1rem 2rem',
                fontFamily: font.dmSans,
            ...
            >
              {loading
                ? <SpinnerIcon />
                : isLogin ? 'Sign In' : 'Join the Academy'
              }
            </button>
          </form>

          {/* Divider */}
          <div className="auth-social-mt" style={{
            display: 'flex',
            alignItems: 'center',
            gap: '1rem',
            margin: '1.75rem 0',
            ...
            <span style={{ fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: C.muted }}>
              or continue with
            </span>
            <div style={{ flex: 1, height: 1, background: 'rgba(201,168,76,0.15)' }}/>
          </div>
          ...
          <p className="auth-toggle-mt" style={{
            textAlign: 'center',
            marginTop: '2rem',
            fontSize: '0.82rem',
            color: C.muted,
          ...
          {/* Footer note */}
          <p className="auth-footer-mt" style={{
            textAlign: 'center',
            marginTop: '2.5rem',
            fontSize: '0.7rem',
            letterSpacing: '0.05em',
            ...
            © {new Date().getFullYear()} Harmony Lifestyle Academy
          </p>
        </div>
      </div>
      ...
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          /* Top-align the form panel on mobile so content isn't clipped on short screens */
          .auth-right-panel {
            align-items: flex-start !important;
            padding-top: 2rem !important;
            padding-bottom: 2rem !important;
          }
          /* Tighten spacing so the whole form fits on small phones */
          .auth-form-card .auth-header-mb {
            margin-bottom: 1.5rem !important;
          }
          .auth-form-card .auth-divider-mb {
            margin-bottom: 1.25rem !important;
          }
          .auth-form-card .auth-social-mt {
            margin-top: 1.25rem !important;
          }
          .auth-form-card .auth-toggle-mt {
            margin-top: 1.25rem !important;
          }
          .auth-form-card .auth-footer-mt {
            margin-top: 1.25rem !important;
          }
        }
